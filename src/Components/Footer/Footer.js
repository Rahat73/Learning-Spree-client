...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-5 bg-slate-300 bg-opacity-10 bg-clip-padding backdrop-filter backdrop-blur-sm rounded-2xl mt-10 justify-around">
                <div>
                    ...
                    <p>©Rahat Ashik<br></br>Learning Spree LTD. 2022</p>
                </div>
                <div>
